      ...
      <div className="relative bg-white dark:bg-[#1B1B1D] p-4 rounded-xl shadow-lg w-full max-w-4xl mx-auto">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <TooltipProvider>
                <Tooltip key="magicPromptTooltip">
                ...
                <Tooltip key="publicToggleTooltip">
                  <TooltipTrigger asChild>
                    <Button
                      variant="outline"
                      size="icon"
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <Palette
                  className={`h-5 w-5 ${
                    isColorPaletteVisible ? "text-white" : "text-gray-700"
                  }`}
                />
              ...
              >
                <Settings
                  className={`h-5 w-5 ${
                    isSettingsPanelVisible ? "text-white" : "text-black"
                  }`}
                />
                <span className="hidden lg:ml-2 lg:inline text-gray-700">
                  Settings
                </span>
              </Button>
            </div>
